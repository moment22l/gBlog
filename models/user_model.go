...
type UserModel struct {
	...
	Role           ctype.Role       `gorm:"size:4;default:1" json:"role"`                                                     // 用户角色
	...
	CollectsModels []ArticleModel   `gorm:"many2many:user2_collects;joinForeignKey:UserID;JoinReferences:ArticleID" json:"-"` // 收藏的文章列表
}
